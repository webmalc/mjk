...
MIGRATION_MODULES = {"sites": "mjk.contrib.sites.migrations"}
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "mjk.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "mjk.users.forms.UserSignupForm"}
